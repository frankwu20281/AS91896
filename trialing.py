...
class MainWindow: 
    ...
    def search_window (self):
        ...
        self.dropdown_menu= OptionMenu(self.SearchWindow, self.dropdown, "Receipt", "Name", "Item", "Search All")
        ...
        if self.all == True:
            self.receipt_storage.bind('<Double-Button>', (lambda event: self.check(self)))
        else:
    ...
    def ceck (self, event):
        typed = self.receipt_storage.get()
